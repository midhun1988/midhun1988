...
<h3 align="center">Senior .NET Developer specializing in ASP.NET Core, Web APIs, SQL Server, and legacy application modernization.</h3>

## What I do
- Build maintainable ASP.NET Core applications and REST APIs
- Modernize legacy ASP/VB applications
- Design database-backed business systems
- Improve performance and reliability of existing platforms
...
- SQL Server, T-SQL, Entity Framework Core, JavaScript  
- REST API design and Swagger
